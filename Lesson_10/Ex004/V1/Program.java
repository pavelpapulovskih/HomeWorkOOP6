...
// Принцип SOLID, который присутствует в данном коде, это принцип единственной ответственности (Single Responsibility Principle - SRP).
// Для соблюдения принципа SRP используються отдельные классы AudioRepository и VideoRepository, каждый из которых будет отвечать только за хранение соответствующего типа контента.